...
p <- ggplot(sf_res, aes(x = date)) + 
  geom_point(data = sf_mod, aes(y = chl)) + 
  geom_line(aes(y = pred, colour = mods), size = 1) + 
  theme_bw() + 
  scale_y_continuous(ylab, limits = c(-1, 2.5)) +
  theme(
    legend.text.align = 1,
...
png('pres_figs/yrseas_sf.png', height = 2, width = 9, units = 'in', res = 300)
print(p)
dev.off()
png('pres_figs/yrseasleg_sf.png', height = 2.5, width = 2, units = 'in', res = 300)
grid.arrange(pleg)
dev.off()
...
png('pres_figs/yrseasfac_sf.png', height = 8, width = 7, units = 'in', res = 300)
print(p)
dev.off()
...
png('pres_figs/withflo_sf.png', height = 2, width = 9, units = 'in', res = 300)
print(p)
dev.off()
png('pres_figs/withfloleg_sf.png', height = 1, width = 2, units = 'in', res = 300)
grid.arrange(pleg)
dev.off()
...
png('pres_figs/sfdyna.png', height = 4, width = 5, units = 'in', res = 300)
grid.arrange(
...
png('pres_figs/withnuts_sf.png', height = 3.5, width = 8, units = 'in', res = 300)
p
dev.off()

...
### Example dataset: import, wranging, and plotting
...
The tidal (estuarine) adaptation of WRTDS can be downloaded from CRAN: [WRTDStidal](https://cran.rstudio.com/web/packages/WRTDStidal/index.html).  Additional information is available on the GitHub page: [desicription](https://github.com/fawda123/WRTDStidal), [tutorial](https://fawda123.github.io/WRTDStidal/descrip).   
